...
感谢你有兴趣为 AiChatX Tools 做出贡献！我们欢迎各种形式的贡献，包括新工具、错误修复和文档改进。
...
[创建工具提交 Issue](https://github.com/aichatx.com.cn/html-tools/issues/new?template=tool-submission.md)
...
AiChatX Tools 采用 GitHub 组织进行管理：

- **aichatx.com.cn/html-tools** - 主网站仓库
- **aichatx.com.cn/tools** - 工具集合仓库（可选）
- **aichatx.com.cn/docs** - 文档仓库（可选）
...
1. 开发者按规范创建工具文件夹和文件
2. 通过 GitHub Issues 提交工具到 aichatx.com.cn/html-tools
3. 维护者审核工具代码和功能
4. 审核通过后，维护者将工具合并到主仓库
5. 更新 index.json 索引文件
6. 工具上线到 AiChatX Tools 网站
...
感谢所有贡献者！你的贡献让 AiChatX Tools 变得更加完善。
